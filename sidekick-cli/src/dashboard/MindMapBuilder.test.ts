...
describe('shortenPath', () => {
  ...
  it('shortens long paths', () => {
    expect(shortenPath('/home/user/projects/my-app/src/services/AuthService.ts')).toBe(
    ...
    m.subagents = [
      {
        ...
        spawnTime: '2025-01-15T10:05:00Z',
        status: 'completed',
        completionTime: '2025-01-15T10:05:05Z',
        durationMs: 5000,
      },
      {
        id: 'tu2',
        ...
        subagentType: 'Bash',
        spawnTime: '2025-01-15T10:06:00Z',
        status: 'running',
      },
    ];
    const tree = buildMindMapTree(m, emptyStaticData());
    ...
    sd.notes = [
      {
        ...
        noteType: 'gotcha',
        content: 'Watch for token expiry race condition',
        status: 'active',
        importance: 'high',
        id: '1',
        source: 'manual',
    ...
    m.subagents = [
      {
        ...
        subagentType: 'Explore',
        spawnTime: '2025-01-15T10:00:00Z',
        status: 'completed',
        completionTime: '2025-01-15T10:00:03Z',
        durationMs: 3000,
      },
      {
        id: 'tu2',
        ...
        subagentType: 'Bash',
        spawnTime: '2025-01-15T10:01:00Z',
        status: 'running',
      },
    ];
    const lines = renderMindMapBoxed(m, emptyStaticData());
    ...
    sd.notes = [
      {
        filePath: 'src/auth.ts',
        noteType: 'gotcha',
        content: 'Token expiry race condition',
        status: 'active',
        importance: 'high',
        id: '1',
        source: 'manual',
