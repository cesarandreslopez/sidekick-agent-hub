/**
 * @fileoverview Converts OpenCode message + parts into SessionEvent format.
 *
 * OpenCode stores messages and their parts as separate JSON/DB records.
 * This module converts them to the SessionEvent format used by
 * SessionMonitor and CLI consumers, enabling all existing event processing
 * logic to work unchanged with OpenCode sessions.
 *
 * Moved from sidekick-vscode/src/services/providers/OpenCodeMessageParser.ts
 *
 * @module parsers/openCodeParser
 */
...
/**
 * Converts an OpenCode message and its parts into SessionEvent array.
 *
 ...
 * @returns Array of SessionEvent objects
 */
