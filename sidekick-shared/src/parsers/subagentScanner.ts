/**
 * @fileoverview Scanner for subagent JSONL files (sidekick-shared).
 *
 ...
 *
 * @module parsers/subagentScanner
 */
 ...
 * @param logger - Optional logging function; messages are silently discarded if not provided
