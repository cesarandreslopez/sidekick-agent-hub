...
const mockStore = {
  ...
  decisions: {
    d1: {
      id: 'd1',
      description: 'Use esbuild for bundling',
      rationale: 'Fast and simple',
      chosenOption: 'esbuild',
    ...
    d2: {
      ...
      rationale: 'Compatible with TypeScript',
      chosenOption: 'vitest',
    ...
    d3: {
      id: 'd3',
      description: 'Adopt strict TypeScript',
      rationale: 'Catch errors early',
      chosenOption: 'strict: true',
